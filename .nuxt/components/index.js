export { default as AddChannel } from '../../components/add/Channel.vue'
export { default as AddCity } from '../../components/add/City.vue'
export { default as AddService } from '../../components/add/Service.vue'
export { default as AddServiceType } from '../../components/add/ServiceType.vue'
export { default as AddTariffType } from '../../components/add/TariffType.vue'
export { default as TableAreas } from '../../components/tables/Areas.vue'
export { default as TableChannels } from '../../components/tables/Channels.vue'
...
export { default as TableServicesTypes } from '../../components/tables/ServicesTypes.vue'
export { default as TableTariffs } from '../../components/tables/Tariffs.vue'
export { default as TableTariffsTypes } from '../../components/tables/TariffsTypes.vue'
...
export const LazyAddChannel = import('../../components/add/Channel.vue' /* webpackChunkName: "components/add-channel" */).then(c => c.default || c)
...
export const LazyAddServiceType = import('../../components/add/ServiceType.vue' /* webpackChunkName: "components/add-service-type" */).then(c => c.default || c)
export const LazyAddTariffType = import('../../components/add/TariffType.vue' /* webpackChunkName: "components/add-tariff-type" */).then(c => c.default || c)
...
export const LazyTableChannels = import('../../components/tables/Channels.vue' /* webpackChunkName: "components/table-channels" */).then(c => c.default || c)
...
export const LazyTableServicesTypes = import('../../components/tables/ServicesTypes.vue' /* webpackChunkName: "components/table-services-types" */).then(c => c.default || c)
...
export const LazyTableTariffsTypes = import('../../components/tables/TariffsTypes.vue' /* webpackChunkName: "components/table-tariffs-types" */).then(c => c.default || c)
